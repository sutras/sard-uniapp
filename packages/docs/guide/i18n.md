...
如果你需要使用其他的语言，欢迎贡献 <a href="https://github.com/sutras/sard-uniapp/pulls" target="_blank">PR</a>，只需在 <a href="https://github.com/sutras/sard-uniapp/tree/main/packages/sard-uniapp/components/locale/lang" target="_blank">这里</a> 添加一个语言配置文件即可。
...
更多字段，可参考 <a href="https://github.com/sutras/sard-uniapp/blob/main/packages/sard-uniapp/components/locale/lang/zh-CN.ts" target="_blank">zh-CN.ts</a>。
