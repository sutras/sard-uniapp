...
| immediate-render <sup>1.30.6+</sup> | 是否立刻渲染 visible 插槽中的内容                                                         | boolean              | false   |
...
| cancel <sup>1.24.2+</sup>        | 自定义取消按钮内容                                                                                                                                         | `{ onClick: () => void; loading: boolean; text: string }`                     |
| confirm <sup>1.24.2+</sup>       | 自定义确定按钮内容                                                                                                                                         | `{ onClick: () => void; loading: boolean; text: string; disabled?: boolean }` |
...
<<< @comp/popout/variables.scss#variables
