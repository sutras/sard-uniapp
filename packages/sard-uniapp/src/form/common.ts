...
export const formItemProps = {
  ...
  direction: {
    type: String as PropType<NonNullable<FormItemProps['direction']>>,
    default: 'horizontal',
  },
  labelWidth: String,
  labelAlign: {
    type: String as PropType<NonNullable<FormItemProps['labelAlign']>>,
    default: 'start',
  },
  labelValign: {
    type: String as PropType<NonNullable<FormItemProps['labelValign']>>,
    default: 'center',
  },
  starPosition: {
    type: String as PropType<NonNullable<FormItemProps['starPosition']>>,
    default: 'left',
  },
  showStar: {
    type: Boolean,
